# weather — example ncode extension (Go, tool-providing)
...
`$NCODE_HOME/extensions/weather/`. ncode picks it up the next time you
...
The tool also shows up in the system prompt's tool list because ncode
