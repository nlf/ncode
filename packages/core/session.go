...
//
//   - Earlier builds that persisted the assistant tool_use row
...
// Cleans up the backlog of empty stubs created by earlier versions
...
// appended (the user opened ncode, looked around, and exited without
